...
if __name__ == "__main__":
    ...
    model.train(X_validation,y_validation,X_train, y_train, epochs=20, learning_rate=lr)
    ...
    #     weights_dict[f'layer_{i}_weights'] = layers.get_weights()
    #     bias_dict[f'layer_{i}_bias'] = layers.get_bias()
    #     i += 1

    # with open('weights.pkl', 'wb') as file:
    #     pickle.dump(weights_dict, file)

    # with open('bias.pkl', 'wb') as file:
    #     pickle.dump(bias_dict, file)
